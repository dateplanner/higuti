...
public class MealSearchActivity extends Activity {
		...
		search.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (category.getSelectedItem() != null) {
					...
					builder.appendQueryParameter("category_l", adapter.getItemKey(position));
				}
				...
				if (prefecture.getSelectedItem() != null) {
					...
					builder.appendQueryParameter("pref", adapter.getItemKey(position));
				}
